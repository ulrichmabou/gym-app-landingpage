...
<SectionWrapper id="faqs">
  ...
  >
    <div class="flex flex-col gap-2">
      <p class="opacity-60 text-base sm:text-lg md:text-sl text-center">
    ...
    <div class="flex flex-col gap=8 sm:gap-10 md:gap-14 w-full">
        {#each faqs as faq}
            <div class="flex flex-col gap-2 text-left max-w-[800px] w-full mx-auto relative p-4 px-6">
                <div class="absolute top-0 left-0 w-1/3 h-[1px] bg-slate-950 -translate-x-1/4">
                </div>
                <div class="absolute top-0 left-0 w
                h-2/3 w-[1px] bg-slate-950 -translate-y-1/4">
                </div>
