...
{#if $openModal}
  ...
  >
    ...
    <div class="flex flex-col gap-4 flex-1">
      ...
      >
        <p class="duration-200 group-hover:pl-2 poppins text-3xl semibold">
          Product <i class="fa-solid fa-chevron-right tex-xl pl-4" />
        </p>
      </button>
      <button
      ...
      >
        <p class="duration-200 group-hover:pl-2 poppins text-3xl semibold">
          Reviews <i class="fa-solid fa-chevron-right tex-xl pl-4" />
        </p>
      </button>
      <button
      ...
      >
        <p class="duration-200 group-hover:pl-2 poppins text-3xl semibold">
          FAQs <i class="fa-solid fa-chevron-right tex-xl pl-4" />
        </p>
      </button>
    </div>
